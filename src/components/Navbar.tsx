          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-card border border-border py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <Link to="/explore-exhibits" className="block px-4 py-2 text-sm hover:bg-accent">Bond Cars</Link>
                <Link to="/explore-exhibits" className="block px-4 py-2 text-sm hover:bg-accent">Gadgets</Link>
                <Link to="/explore-exhibits" className="block px-4 py-2 text-sm hover:bg-accent">Movie Props</Link>
                <Link to="/explore-exhibits" className="block px-4 py-2 text-sm hover:bg-accent">Wardrobe</Link>
              </div>
            </div>
            ...
            <Button variant="default" size="sm" asChild>
              <Link to="/plan-your-visit">VISIT</Link>
            </Button>
          </div>
            ...
            <div className="flex flex-col p-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link to="/explore-exhibits" className="block text-sm py-1" onClick={toggleMenu}>Bond Cars</Link>
                  <Link to="/explore-exhibits" className="block text-sm py-1" onClick={toggleMenu}>Gadgets</Link>
                  <Link to="/explore-exhibits" className="block text-sm py-1" onClick={toggleMenu}>Movie Props</Link>
                  <Link to="/explore-exhibits" className="block text-sm py-1" onClick={toggleMenu}>Wardrobe</Link>
                </div>
              </div>
              ...
              <Button variant="default" size="sm" className="w-full" asChild>
                <Link to="/plan-your-visit" onClick={toggleMenu}>VISIT</Link>
              </Button>
            </div>
          </div>
        )}
